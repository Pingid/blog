...
var feed = new RSS({
    ...
    feed_url: 'http://www.danbeaven.co.uk/blog/feed.xml',
    site_url: 'http://www.danbeaven.co.uk/blog',
    image_url: '',
...
posts.forEach(x => {
  feed.item({
    ...
    url: `http://www.danbeaven.co.uk/blog/#/${routeTitle(x.title)}`, // link to the item
...
const JSONFeed = {
  ...
  home_page_url: 'http://www.danbeaven.co.uk/blog/',
  feed_url: 'http://www.danbeaven.co.uk/blog/feed.json',
  author: {
      name: 'Dan Beaven',
      url: 'http://www.danbeaven.co.uk',
  },
  items: posts.map(x => ({
    id: routeTitle(x.title),
    title: x.title,
    summary: x.meta.description || '',
    url: `http://www.danbeaven.co.uk/blog/#/${routeTitle(x.title)}`,
